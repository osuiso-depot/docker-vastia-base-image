...
1. [About the Tensorflow Image](#about-the-tensorflow-image)
...
## About the Tensorflow Image

This Tensorflow container image builds upon the Vast.ai [base image](https://github.com/vast-ai/base-image), inheriting all its core functionality documented on this page.
...
Tensorflow comes pre-configured in the primary virtual environment at `/venv/main/`. Multiple versions are available - use the `Version Tag` selector to choose a specific release instead of the default.
...
- [Image Source](https://github.com/vast-ai/base-image/tree/main/derivatives/tensorflow)
