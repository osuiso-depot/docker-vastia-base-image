...
1. [About the ComfyUI Image](#about-the-comfyui-image)
    - [Upgrading ComfyUI](#upgrading-comfyui)
...
## About the ComfyUI Image

This ComfyUI image is built and maintained by Vast.ai. It contains development libraries to enable building custom extensions and add-ons. Please see the associated documentation below for configuration details.

ComfyUI is shipped with ComfyUI Manager pre-installed.

The installation directory is `/workspace/ComfyUI`, where you can download models and extensions.
...
ComfyUI can be upgraded through the included ComfyUI Manager node, or you can upgrade by checking out a new version with Git, installing the requirements, and restarting ComfyUI.
...
1. On the __destination__ instance:
   ...
   - Run: `cd /workspace/ && rm -rf ComfyUI`
...
#### Example: Forwarding ComfyUI to localhost

To forward ComfyUI to your local machine:
...
- Creates a SSH local port forward for your localhost:8188
- Connects to the instance internal ComfyUI port (18188)
- Allows you to access the application at http://localhost:8188 on your machine
...
| `COMFYUI_ARGS` | string | `--disable-auto-launch --port 18188` | Startup arguments to pass to ComfyUI |
