...
1. [About the Fooocus Image](#about-the-fooocus-image)
    - [Upgrading Fooocus](#upgrading-Fooocus)
...
| `FOOOCUS_ARGS` | string | `--port 17865` | Startup arguments to pass to Fooocus |
