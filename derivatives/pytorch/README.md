...
## About the PyTorch Image

This PyTorch container image builds upon the Vast.ai [base image](https://github.com/vast-ai/base-image), inheriting all its core functionality documented on this page.
